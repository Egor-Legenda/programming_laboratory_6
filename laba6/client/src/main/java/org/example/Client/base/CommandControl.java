...
import org.example.Client.commandIn.Commands;
import org.example.Client.exceptions.IOException;
                        ...
                        switch (println) {
                            ...
                            case "count_less_than_climate","filter_starts_with_name","remove_by_id","update":
                                if (words.length==2) {
                                    ...
                                    getCommand(println).execution(line);
