...
public class City implements Serializable {
    ...
    public City(long id, String name, Coordinates coordinates, LocalDateTime creationDate, float area, long population, double metersAboveSeaLevel, boolean capital, double populationDensity, Climate climate, Human governor) {
        this.id = id;
        this.name = name;
